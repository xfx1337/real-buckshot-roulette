...
# 'phone' — капсюль телефонной трубки. Он висит на отдельном выходе (трубка
# воткнута в ноутбук своим кабелем), и именно поэтому у него свой канал: иначе
# реплика информатора ушла бы туда же, куда музыка стола, и её услышала бы вся
# комната вместо того, кто снял трубку.
CHANNEL_NAMES = ("game", "video", "phone")
