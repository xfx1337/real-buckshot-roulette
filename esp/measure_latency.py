...
def main() -> None:
    ...
    print("=" * 40)
    print("Напоминание: задержку определяет в основном интервал между 1-м и 2-м")
    print("RF-пакетом (нужны 2 для подтверждения). Хочешь быстрее — можно снизить")
    print("rf_confirm_count до 1 в config.json, но вырастет риск ложных срабатываний.")
